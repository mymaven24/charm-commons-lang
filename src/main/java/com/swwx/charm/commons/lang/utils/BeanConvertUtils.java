...
import com.swwx.charm.commons.lang.base.CollectionTO;
...
public abstract class BeanConvertUtils {
    ...
    public static <T> CollectionTO<T> convert(CollectionTO<?> col, Class<T> targetClass) {
        return new CollectionTO<T>(convert(col.getList(), targetClass), col.getRecordCnt(), col.getPageSize());
    }

    public static <T> CollectionTO<T> convertIgnoreNullProperty(CollectionTO<?> col, Class<T> targetClass) {
        return new CollectionTO<T>(convertIgnoreNullProperty(col.getList(), targetClass), col.getRecordCnt(),
            col.getPageSize());
    }
